export const Stats = function () {
    ...
    var msColor = 'yellow';
    var mbColor = 'white';
    var fpsPanel = addPanel(createPanel('FPS', fpsColor, bgColor));
    var msPanel = addPanel(createPanel('MS', msColor, bgColor));

    if (self.performance && self.performance.memory) {
        var memPanel = addPanel(createPanel('MB', mbColor, bgColor));
    }
